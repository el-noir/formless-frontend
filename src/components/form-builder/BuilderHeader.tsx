        ...
        <header className="flex items-center justify-between px-4 h-12 border-b border-gray-800/80 shrink-0 bg-[#0B0B0F]">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 bg-brand-purple hover:bg-[#0da372] disabled:opacity-60 text-white text-xs font-medium px-4 py-1.5 rounded transition-colors"
                >
                    {isPublishing ? (
                        <>
