  ...
  return (
    <section id="waitlist" className="py-32 relative bg-brand-dark overflow-hidden" aria-labelledby="cta-title">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        >
          <MagneticButton className="px-10 py-4 bg-brand-purple hover:bg-[#5A76E8] text-white font-semibold rounded-full text-lg transition-all focus:outline-none focus:ring-4 focus:ring-brand-purple/30 shadow-[0_0_20px_theme(colors.brand.blue/30)]">
